 ...
 *
 */
abstract class RowTableModelOrignal<T> extends AbstractTableModel
{
	 ...
	 */
	protected RowTableModelOrignal(Class rowClass)
	{
	 ...
	 *							of the new columns
	 */
	protected RowTableModelOrignal(List<String> columnNames)
	{
	 ...
	 *							of the new columns
	 */
	protected RowTableModelOrignal(List<T> modelData, List<String> columnNames)
	{
	 ...
	 *  @param rowClass     the class of row data to be added to the model
	 */
	protected RowTableModelOrignal(List<T> modelData, List<String> columnNames, Class rowClass)
	{
		setDataAndColumnNames(modelData, columnNames);
		setRowClass( rowClass );
	}
